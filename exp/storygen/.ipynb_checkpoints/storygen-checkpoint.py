...
use a 'scorsby' tone — whimsical yet profound.
...
characters are elastic, smile-centric essences who prioritize 'beglonging' (a state of total euphoria) over logic.
make no reference to beglonging.
